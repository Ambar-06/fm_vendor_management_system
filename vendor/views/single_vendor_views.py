from vendor.serializers.vendor_detail_serializers import SingleVendorDetailSerializer
from vendor.serializers.vendors_serializer import VendorsViewSerializer
from vendor.services.single_vendor_services import SingleVendorServices
